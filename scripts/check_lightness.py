...
def check_within_same_data( data , cam_extrinsic, o3d_intrinsic, original_image_size, resized_intrinsic_o3d, resized_image_size, bound_box):
...
def main():
    ...
    data1 = np.load( "./env/oct28_morning_1pm.npy", allow_pickle = True)
    data2 = np.load( "./env/oct27_night_10pm.npy", allow_pickle = True)
    
    bgr1 = data1[0]['bgr']
    bgr2 = data2[0]['bgr']
    # bgr2 = data1[1]['bgr']
    # print("diff")()
    data1_prcessed_rgb, data1_prcessed_xyz = check_within_same_data( data1 , cam_extrinsic, o3d_intrinsic, original_image_size, resized_intrinsic_o3d, resized_image_size, bound_box)
    data2_prcessed_rgb, data2_prcessed_xyz = check_within_same_data( data2 , cam_extrinsic, o3d_intrinsic, original_image_size, resized_intrinsic_o3d, resized_image_size, bound_box)
    ...
    print("total diff: ",LA.norm(img1 - img2))

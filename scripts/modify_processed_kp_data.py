    ...
    for data_idx in data_idxs:
        ...
        for idx, frame in enumerate(episode[0]):
            ...
            if(to_plane):
                ...
                # resized_xyz[green_idx] =
                test = resized_xyz[green_idx]
                test[:,2] = 0.0
                resized_xyz[green_idx] = test
            ...
            if(change_obj_rgb):
                ...
                resized_img_data[green_idx] = test
            ...
            if(change_env_rgb):
                ...
                resized_img_data -= 0.1
                resized_img_data = np.clip( resized_img_data, 0, 1)
        ...
        if(to_plane):
            np.save("ep{}_plane".format(data_idx), episode)

        if(change_obj_rgb):
            np.save("ep{}_obj_rgb".format(data_idx), episode)

        if(change_env_rgb):
            np.save("ep{}_env_rgb".format(data_idx), episode)

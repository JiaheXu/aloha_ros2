...
def main() -> None:
    ...
    #########################################
    action = []
    action.append( np.array([0.3, 0., 0.4, 0., 0., 0., 1., 1.6]) )
    action.append( np.array([0.3, 0., 0.3, 0., 0., 0., 1., 1.6]) )
    action.append( np.array([0.3, 0., 0.2, 0., 0., 0., 1., 1.6]) )
    action = np.array( action )
    action.reshape(-1,8)
